<!-- https://www.codewars.com/kata/62c93765cef6f10030dfa92b/train/php
...
function cats(int $start, int $finish): int {
  $big_jumps = ($finish - $start) / 3;
  if (is_int($big_jumps)){
    return $big_jumps;
  }else{
    if (round($big_jumps - floor($big_jumps)) == 0){
      return floor($big_jumps)+1;
    }else{
      return floor($big_jumps)+2;
    }
  }
}
